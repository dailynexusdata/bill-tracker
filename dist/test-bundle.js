...
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nconst d3_selection_1 = __webpack_require__(/*! d3-selection */ \"./node_modules/d3-selection/src/index.js\");\r\nconst makeBill = (data) => { };\r\nconst makeTable = (data) => {\r\n    const container = (0, d3_selection_1.select)('#labby-as-bill-tracker-slider').attr('class', 'labby-as-senate-styling');\r\n};\r\nexports.default = makeTable;\r\n\n\n//# sourceURL=webpack://bill-tracker/./src/plots/slider.ts?");
